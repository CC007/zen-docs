...
You can also download Zen tarball and AppImage files directly, as well as formats for other OS in [latest Zen Github Releases](https://github.com/zen-browser/desktop/releases/latest) page.
